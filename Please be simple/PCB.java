...
public class PCB{
    ...
    //     this.PID = PID;
    //     this.loadedTime = arrTime;
    //     this.setPState(ProcessState.WAITING);
    //     this.burstQueue = new LinkedList<Burst>();
    //     this.memoryUsed = 0;
	...
	public String toString() {
        ...
        + "\nTotal time spent in the CPU: " +this.CPUTotalTime
    ...
    void incrementIOTime() { this.IOTime++; }
	...
	ProcessState getPState() { return PState; }
	void setPState(ProcessState PState) { this.PState = PState; }

	int getPrSize() { return PrSize; }
	void setPrSize(int PrSize) { this.PrSize = PrSize; }

	Burst getCurrentBurst() { return this.currentBurst; }
	
    int getCPUCounter() { return CPUCounter; }
    
    int getIOCounter() { return IOCounter; }
    
    int getMemoryCounter() { return memoryCounter;}
     
    int getIOTime() { return IOTime; }
    
    int getCPUTotalTime() { return CPUTotalTime; }
